    ...
    <div className="w-full md:w-1/2 lg:w-full xl:w-full p-2">
      <div className="bg-gray-100 p-4 rounded-lg shadow-md">
        ...
        <div className="flex flex-wrap">
          <span className="text-gray-700 text-sm mr-2 mb-2 bg-slate-300 px-2 rounded-md">{type}</span>
          <span className="text-gray-700 text-sm mr-2 mb-2 bg-slate-300 px-2 rounded-md">Relevance score: {score}</span>
        </div>
      </div>
    </div>
  );
