          ...
          <div className="left flex gap-3">
            ...
            <form action=''>
              <div className='relative flex items-center text-gray-400 focus-within:text-gray-600'>
                <input type='text' name='search' placeholder='Search Discussion' autoComplete='off' aria-label='Search Discussion' className='pr-3 pl-10 py-2 placeholder-gray-500 text-black rounded-md border-none ring-2 ring-gray-300 focus:ring-gray-500 focus:ring-2 '/>
