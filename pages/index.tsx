          ...
          <div className="left flex gap-3">
            ...
            <form action=''>
              <div className='relative flex items-center text-gray-400 focus-within:text-gray-300'>
                <input type='text' name='search' placeholder='Search Discussion' autoComplete='off' aria-label='Search Discussion' className='pr-3 pl-10 py-2 placeholder-gray-400 text-black rounded-md border-2 focus:outline-none focus:border-gray-400 focus:placeholder-gray-300'/>
